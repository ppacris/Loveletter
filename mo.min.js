    ...
    return function (t) {
            ...
            T = function (t) {
                ...
                return h["default"](e, t), e.prototype._declareDefaults = function () {
                    this._defaults = {
                        ...
                        el: 1
                    }, this._3dProperties = ["angleX", "angleY", "z"], this._arrayPropertyMap = {
                        transformOrigin: 1,
                ...
                }, e.prototype._makeTween = function () {}, e.prototype._makeTimeline = function () {
            ...
            m = function (t) {
                ...
                return u["default"](e, t), e.prototype._declareDefaults = function () {
                    ...
                    if (s.speed && this._playTime && (t = this._playTime + s.speed * (t - this._playTime)), Math.abs(s.endTime - t) < 1e-8 && (t = s.endTime), i && null != r) {
                        ...
                        if (this._timelines)
                            for (var p = 0; p < this._timelines.length; p++) this._timelines[p]._update(t, e, r, i);
        ...
        var o = r(19),
            a = (i(o), function () {
                ...
                return t.prototype._vars = function () {
                    ...
                    var e = "number" == typeof t ? t : this.tweens.indexOf(t); - 1 !== e && (t = this.tweens[e], t && (t._isRunning = !1, this.tweens.splice(e, 1), t._onTweenerRemove()))
        ...
        var s = r(18),
            ...
            l = function () {
                ...
                }, t.prototype._showByTransform = function () {}, t.prototype._parseOptionString = function (t) {
        ...
        i = function () {
            ...
            return t.prototype.NS = "http://www.w3.org/2000/svg", t.prototype.logBadgeCss = "background:#3A0839;color:#FF512F;border-radius:5px; padding: 1px 5px 2px; border: 1px solid #FF512F;", t.prototype.shortColors = {
                ...
                if (r = t.length, i = e.length, r > i)
                    for (p = r - i, h = e.length, n = o = 0, u = p; u >= 0 ? u > o : o > u; n = u >= 0 ? ++o : --o) s = n + h, e.push(this.parseUnit("0" + t[s].unit));
                else if (i > r)
                    for (p = i - r, h = t.length, n = a = 0, l = p; l >= 0 ? l > a : a > l; n = l >= 0 ? ++a : --a) s = n + h, t.push(this.parseUnit("0" + e[s].unit));
                return [t, e]
        ...
        (function (e) {
            ...
            n = r(19), i = function () {
                ...
                return t.prototype.vars = function () {
                    ...
                    for (S = P = 0; 4 > P; S = ++P)
                        if (d = arguments[S], "number" != typeof d || isNaN(d) || !isFinite(d)) return this.error("Bezier function expects 4 arguments");
                    return 0 > t || t > 1 || 0 > i || i > 1 ? this.error("Bezier x values should be > 0 and < 1") : (u = 4, l = .001, c = 1e-7, h = 10, T = 11, x = 1 / (T - 1), v = o.call(e, "Float32Array") >= 0, n = function (t, e) {
                        ...
                        for (o = void 0, n = void 0, S = 0;;)
                            if (n = r + (s - r) / 2, o = y(n, t, i) - e, o > 0 ? s = n : r = n, a = Math.abs(o) > c, !(a && ++S < h)) break;
                        return n
                    }, b = function (e) {
                        var r, s, n, o, a, p, u;
        ...
        s = r(19), i = function () {
            ...
            return t.prototype._vars = function () {
                ...
                var r, i, s, n, o, a, p, u, l, h;
                if (null == e && (e = 0), t = t.trim(), o = /(-|\+)?((\d+(\.(\d|\e(-|\+)?)+)?)|(\.?(\d|\e|(\-|\+))+))/gim, a = this._getSegmentPairs(t.match(o)), s = a[a.length - 1], h = s[0], p = Number(h), p !== e)
        ...
        s = null, a = function (t) {
            ...
            var t;
            return t = 1 <= arguments.length ? u.call(arguments, 0) : [], t.length > 1 ? t = t.sort(p) : t[0].value = a(t[0]),
                function (e) {
                    var r, i;
        ...
        var i = r(66),
            ...
            j = function (t, e, r) {
                return r && n(A, e) ? (r.enumerable ? (n(t, D) && t[D][e] && (t[D][e] = !1), r = P(r, {
                    enumerable: w(0, !1)
                })) : (n(t, D) || S(t, D, w(1, {})), t[D][e] = !0), I(t, e, r)) : S(t, e, r)
            },
            X = function (t, e) {
                g(t);
        ...
        i.each.call("hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), function (t) {
            ...
            Symbol: T
        }), a(a.S, "Symbol", W), a(a.S + a.F * !L, "Object", {
            create: U,
            defineProperty: j,
            defineProperties: X,
            ...
            stringify: q
        }), h(T, "Symbol"), h(Math, "Math", !0), h(s.JSON, "JSON", !0)
        ...
        t.exports = function (t) {
            var e = i.getKeys(t),
                r = i.getSymbols;
            if (r)
                for (var s, n = r(t), o = i.isEnum, a = 0; n.length > a;) o.call(t, s = n[a++]) && e.push(s);
            return e
        }
    }, function (t, e, r) {
        var i = r(104);
